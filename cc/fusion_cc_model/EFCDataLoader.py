...
class TestDataLoader(data.Dataset):
    def __init__(self,test_index, tests, target, ssp, cr, sf):
    ...
    def __getitem__(self, item):
        return self.test_index[item],self.tests[item], self.target[item], self.ssp[item], self.cr[item], self.sf[item]
