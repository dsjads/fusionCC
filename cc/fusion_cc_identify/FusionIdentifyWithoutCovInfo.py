...
from cc.fusion_cc_model.EFCDataLoader import CombinedInfoLoaderWithoutCovInfo
from cc.fusion_cc_model.FusionNet import ExpertNet, ExpertNet1
...
class FusionIdentifyWithoutCovInfo(BaseCCPipeline):
