...
from cc.fusion_cc_model.FusionNet import ExpertNet, ExpertNet2
...
class CBNNCCIdentify(BaseCCPipeline):
    ...
    def _find_cc_index(self):
        ...
        for item in self.train_test_config_list:
            ...
            save_path = os.path.join(project_dir, "results", "2025-02-17-CBNN", "time.txt")
...
if __name__ == "__main__":
    ...
    for program in program_list:
        ...
        cbccpl = CBNNCCIdentify(project_dir, configs, 1, "2022-09-21-CBNN", 5)
